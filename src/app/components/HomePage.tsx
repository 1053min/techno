    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white px-6 py-8">
      <div className="max-w-md mx-auto">
        ...
        <div className="flex justify-between items-start mb-12">
          ...
          {/* ⚡ 크레딧 시스템 Mock-up */}
          <div className="flex items-center gap-1.5 bg-white border border-orange-200 px-3 py-1.5 rounded-full shadow-sm">
        ...
        <button
          ...
          className="w-full bg-orange-500 text-white rounded-3xl p-8 mb-8 shadow-lg hover:shadow-xl transition-all active:scale-95 text-left"
        >
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <button 
            ...
            className="bg-white rounded-2xl p-6 shadow-xs hover:shadow-md transition-shadow text-left border border-slate-100 hover:ring-2 hover:ring-orange-500/20"
          >
        ...
        <button
          ...
          className="mt-6 w-full bg-black text-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition-all text-center flex items-center justify-center gap-2"
        >
